 ...
 * \param MACbuffer		Zeiger auf den Speicher in der die MAC gespeichert werden soll.
 * \param MACbuffer		Zeiger auf den Speicher in der die ttl gespeichert werden soll.
