...
///	\par Uebersicht
///		Die Lib stellt Funktionen um die Tsunami-Streamingengine zu steuern per
 ...
 */
/*------------------------------------------------------------------------------------------------------------*/
void mp3clientupdate( long bandwidth, unsigned int tcpbuffer, unsigned int streamingbuffer, unsigned int decodetime, unsigned char verboselevel )
{
