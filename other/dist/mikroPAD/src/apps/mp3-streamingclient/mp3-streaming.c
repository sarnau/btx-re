...
volatile unsigned int MP3_SOCKET = NO_SOCKET_USED;
volatile unsigned char MP3_FIFO = 0;
volatile unsigned long totalbytes = 0;
volatile unsigned int vol = 240;
volatile unsigned int mp3timer = 0xffff;
...
volatile unsigned char mp3_buffer[ mp3_buffer_size ];
