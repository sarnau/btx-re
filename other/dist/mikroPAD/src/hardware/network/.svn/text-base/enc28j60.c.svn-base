 ...
 unsigned char enc28j60ReadOp( unsigned char op,  unsigned char address)
{
	...
	data = SPI1_ReadWrite( op | (address & ADDR_MASK) );
...
//	ENC28J60_CONTROL_PORT |= 1<<ENC28J60_CONTROL_CS;
    ...
    // setup duplex ----------------------
	*/
	// hier sollte mal gewartet werden, sonst steht der link nach der Reconfig nicht richtig
	CLOCK_delay(2000);
